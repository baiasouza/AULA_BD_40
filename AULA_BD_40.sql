...
select * from acoes where not pl > 25 and not psr <1 and not patrimonio_liquido <100000000000;

select * from acoes where not pl > 25 and patrimonio_liquido >100000000000 and cotacao between 30 and 50 order by cotacao desc limit 5;
